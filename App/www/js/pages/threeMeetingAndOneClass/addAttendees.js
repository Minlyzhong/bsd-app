define(['app',
	...
	function initData(pageData) {
		...
		deptIdList = {};
		oldContent = '';
		leaderList = JSON.parse(pageData.listAttendees);
	...
	function payDetail() {
		...
		function backAction() {
			...
			require(['js/pages/threeMeetingAndOneClass/threeMeetingAndOneClassAdd'],function(threeMeetingAndOneClassAdd){
				threeMeetingAndOneClassAdd.addAttendeesBack(leaderList);
			});
		}
	}
	...
	function findDeptPeople(deptId, deptName) {
		app.myApp.getCurrentView().loadPage('showAttendees.html?deptName=' + deptName + '&deptId=' + deptId + '&backPage=addAttendees');
		return;
	}
	...
	function pushAndPull(page) {
		//加载更多
		var loadMoreContent = $$(page.container).find('#paySearchView');
