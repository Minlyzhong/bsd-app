define(['app','hbs!js/hbs/recordRmLeader'], function(app,recordRmLeaderTemplate) {
	...
	function init(page) {
		...
		app.myApp.onPageBack("threeMeetingAndOneClass/threeMeetingAndOneClassAdd", function(page){
