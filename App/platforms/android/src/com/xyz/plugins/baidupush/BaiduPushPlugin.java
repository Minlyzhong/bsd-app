                ...
                try {
                    if ("startWork".equals(action)) {
						...
						if(Build.VERSION.SDK_INT >= 21){
							...
							builder.setStatusbarIcon(cordova.getActivity().getResources().getIdentifier("ic_launcher","drawable",cordova.getActivity().getPackageName()));
							PushManager.setDefaultNotificationBuilder(cordova.getActivity().getApplicationContext(),builder);
						}
