...
- (UIImage*)buildReticleImage: (CGFloat)toolBarHeight;
...
- (UIView*)buildOverlayView {
    ...
    UIImage* reticleImage = [self buildReticleImage:toolbarHeight];
...
//                          minAxis
//                          );
    rectArea = [[UIScreen mainScreen] bounds];
...
//    }
    ...
    CGFloat _x =  centerPoint.x- 150;
    CGFloat _y = centerPoint.y- 150;
    ...
    CGContextSetStrokeColorWithColor(context, color.CGColor);
    CGContextStrokeRectWithWidth(context, CGRectMake(_x, _y- 25, 300, 300), 2.0f);
    
    CGContextClearRect(context, CGRectMake(_x, _y-25, 300, 300));
    CGContextClearRect(context, CGRectMake(0, [[UIScreen mainScreen] bounds].size.height - toolBarHeight, [[UIScreen mainScreen] bounds].size.width, toolBarHeight));
